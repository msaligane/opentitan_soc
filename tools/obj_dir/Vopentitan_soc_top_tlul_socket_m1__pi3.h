...
VL_MODULE(Vopentitan_soc_top_tlul_socket_m1__pi3) {
  public:
    ...
    VL_IN8(clk_i,0,0);
    VL_IN8(rst_ni,0,0);
    // Begin mtask footprint all: 25 26 27 28 30 34 
    VL_INW(tl_h_i[2],85,0,3);
    // Begin mtask footprint all: 25 26 27 28 31 34 
    VL_OUT64(tl_h_o[2],51,0);
    // Begin mtask footprint all: 2 6 7 9 14 20 25 26 28 29 30 31 33 37 
    ...
    // Begin mtask footprint all: 6 7 14 25 26 27 28 30 34 
    ...
    // Begin mtask footprint all: 6 7 14 25 26 27 28 31 34 
    CData/*1:0*/ __PVT__hfifo_rspvalid;
    // Begin mtask footprint all: 2 6 7 14 20 25 26 27 28 29 30 31 34 
    QData/*51:0*/ __PVT__drsp_fifo_o;
    CData/*1:0*/ __PVT__hrequest;
    // Begin mtask footprint all: 2 20 25 26 27 28 29 30 31 34 
    WData/*85:0*/ __PVT__hreq_fifo_o[2][3];
    CData/*1:0*/ __PVT__gen_arb_ppc__DOT__u_reqarb__DOT__gen_normal_case__DOT__winner;
    // Begin mtask footprint all: 2 20 25 26 28 29 30 31 
  ...
  public:
    ...
    void _combo__TOP__opentitan_soc_top__DOT__periph_switch__DOT__DCCM__242(Vopentitan_soc_top__Syms* __restrict vlSymsp);
    void _combo__TOP__opentitan_soc_top__DOT__periph_switch__DOT__LDO1__243(Vopentitan_soc_top__Syms* __restrict vlSymsp);
    void _combo__TOP__opentitan_soc_top__DOT__periph_switch__DOT__TSEN1__244(Vopentitan_soc_top__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    void _sequent__TOP__opentitan_soc_top__DOT__periph_switch__DOT__TSEN2__239(Vopentitan_soc_top__Syms* __restrict vlSymsp);
