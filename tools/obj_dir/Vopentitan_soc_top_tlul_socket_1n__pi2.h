...
VL_MODULE(Vopentitan_soc_top_tlul_socket_1n__pi2) {
  public:
    ...
    // PORTS
    // Begin mtask footprint all: 17 36 37 43 44 
    VL_OUT64(tl_h_o,51,0);
    // Begin mtask footprint all: 31 36 43 
    ...
    // LOCAL SIGNALS
    // Begin mtask footprint all: 8 11 23 24 
    IData/*16:0*/ __PVT__num_req_outstanding;
    // Begin mtask footprint all: 8 11 23 24 36 43 
    WData/*85:0*/ __PVT__tl_u_o[14][3];
    CData/*3:0*/ __PVT__dev_select_outstanding;
    // Begin mtask footprint all: 8 23 24 36 37 43 
    WData/*85:0*/ __PVT__tl_t_o[3];
    // Begin mtask footprint all: 23 24 36 43 
    CData/*0:0*/ __PVT__hold_all_requests;
    // Begin mtask footprint all: 8 11 36 43 
    ...
    // Begin mtask footprint all: 8 11 
  ...
  public:
    ...
    void _combo__TOP__opentitan_soc_top__DOT__periph_switch__DOT__u_s1n_10__35(Vopentitan_soc_top__Syms* __restrict vlSymsp);
    void _combo__TOP__opentitan_soc_top__DOT__periph_switch__DOT__u_s1n_10__41(Vopentitan_soc_top__Syms* __restrict vlSymsp);
    void _combo__TOP__opentitan_soc_top__DOT__periph_switch__DOT__u_s1n_11__37(Vopentitan_soc_top__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    void _sequent__TOP__opentitan_soc_top__DOT__periph_switch__DOT__u_s1n_11__36(Vopentitan_soc_top__Syms* __restrict vlSymsp);
